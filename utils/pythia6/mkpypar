...
while [ ! -z "$1" ]; do
	...
	echo "          --targetP    [target momentum] ($targetP)"
...
###
    ...
    echo -e "CKIN(65)=$Q2min" "\t ### min photon virtuality, Q2 (D = 0.)"
    echo -e "CKIN(66)=$Q2max" "\t ### max photon virtuality, Q2 (D = -1.)"
    echo -e "CKIN(73)=$Ymin"  "\t ### min light-cone fraction, y (D = 0.0001)"
